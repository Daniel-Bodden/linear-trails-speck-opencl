                                        ...
                                        )
{
    ...
    size_t gidDim3 = get_global_id(2); // work item number
   ...
   else if( checkTwoConsecutiveBits( (  ((inWords[(gidDim2)] << 32 ) | inWords[(gidDim1)] ) &  0xffffffff ) ,128)  )  // word not zero and pairs are consequtive
    {
	__private uint blocksize = 128;
        __private uint rounds = 22;
       /************************************************************************************
        **************************CHECK 0x6... and 0x7... ***********************************/
       if (  (((inWords[gidDim1]>>28)&0xf) == 0x6) | (((inWords[gidDim1]>>28)&0xf) == 0x7) ) 
 	 {
	   __private uint initialblock = 31;


	   cipherRoundFunction(
                                
				( (inWords[(gidDim2)] << 31 ) | inWords[(gidDim1)] ),
				0,
                                blocksize,
                                rounds,
  	   ...
  	   cipherRoundFunction(
                               ( (inWords[(gidDim2)] << 31 ) | inWords[(gidDim1)] ),
				( ( inWords[(fourthDim[0])]  << 31 ) | inWords[(gidDim3)] ),
                                blocksize,
                                rounds,
                               outputBestRoundCombo,               //OUTPUT - write the best round combo (forward, backward)
                               outMasksBestRoundBackward,          //OUTPUT - write the best round backward
       ...
       else // not equal to 0x6 or 0x7
       {
	   __private uint initialblock = 32;
	
	   cipherRoundFunction(
                                
				( (inWords[(gidDim2)] << 32 ) | inWords[(gidDim1)] ),
				0,
                                blocksize,
                                rounds,
                               outputBestRoundCombo,               //OUTPUT - write the best round combo (forward, backward)
            ...
            cipherRoundFunction(
                               ( (inWords[(gidDim2)] << 32 ) | inWords[(gidDim1)] ),
				( ( inWords[(fourthDim[0])]   << 32 ) | inWords[(gidDim3)] ),
                                blocksize,
                                rounds,
                               outputBestRoundCombo,               //OUTPUT - write the best round combo (forward, backward)
                               outMasksBestRoundBackward,          //OUTPUT - write the best round backward
...
//Variables
	...
	ulong const firstJump = 75024;
    ulong const secondJump = 75024;
  	//ulong const thirdJump = 75024;
        
        outWords[gid] =  inWords[gid];
        
	    /************************************************************************************
        **************************CHECK 0x6... and 0x7... ***********************************/
        if (  (((inWords[gid]>>20)&0xf) == 0x6) | (((inWords[gid]>>20)&0xf) == 0x7)) 
        {
	     ulong const ti0= 0x3;                   //Starting position left side
         ulong const word_size = 0xffffff;         //Needs to be changed        //Size of the word
         //ulong const zeroRight =0x000000;       //right side is zero
         ulong const initialBlock =23;           //15 bits generated on the host most right bits
	     counter = 0;
         
         for (ulong ti1=ti0;ti1<word_size;ti1=ti1*2)
         {
             outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1) << initialBlock) |  ( inWords[gid]));
             counter++;
             for (ulong ti2=ti1<<2;ti2<word_size;ti2=ti2*2)
             {
               outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2) << initialBlock) |  ( inWords[gid]));
               counter++;
	           for (ulong ti3=ti2<<2;ti3<word_size;ti3=ti3*2)
               {
               	outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2^ti3) << initialBlock) |  ( inWords[gid]));
               	counter++;
		        for (ulong ti4=ti3<<2;ti4<word_size;ti4=ti4*2)
                {
               	  outWords[(((gid*secondJump)+(counter+firstJump)))]=  (((ti1^ti2^ti3^ti4) << initialBlock) |  ( inWords[gid]));
               	  counter++;
                  for (ulong ti5=ti4<<2;ti5<word_size;ti5=ti5*2)
                  {
               	    outWords[(((gid*secondJump)+(counter+firstJump)))]=  (((ti1^ti2^ti3^ti4^ti5) << initialBlock) |  ( inWords[gid]));
               	    counter++;
                    for (ulong ti6=ti5<<2;ti6<word_size;ti6=ti6*2)
                    {
               	      outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2^ti3^ti4^ti5^ti6) << initialBlock) |  ( inWords[gid]));
               	      counter++;
                      for (ulong ti7=ti6<<2;ti7<word_size;ti7=ti7*2)
                      {
               	        outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2^ti3^ti4^ti5^ti6^ti7) << initialBlock) |  ( inWords[gid]));
                        counter++;
                        for (ulong ti8=ti7<<2;ti8<word_size;ti8=ti8*2)
                        {
               	           outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2^ti3^ti4^ti5^ti6^ti7^ti8) << initialBlock) |  ( inWords[gid]));
               	           counter++;
                            for (ulong ti9=ti8<<2;ti9<word_size;ti9=ti9*2)
                           {
               	             outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2^ti3^ti4^ti5^ti6^ti7^ti8^ti9) << initialBlock) |  ( inWords[gid]));
               	             counter++;
                             for (ulong ti10=ti9<<2;ti10<word_size;ti10=ti10*2)
                             {
               	               outWords[(((gid*secondJump)+(counter+firstJump)))]=  (((ti1^ti2^ti3^ti4^ti5^ti6^ti7^ti8^ti9^ti10) << initialBlock) |  ( inWords[gid]));
               	               counter++;
                               for (ulong ti11=ti10<<2;ti11<word_size;ti11=ti11*2)
                               {
               	                 outWords[(((gid*secondJump)+(counter+firstJump)))]=  (((ti1^ti2^ti3^ti4^ti5^ti6^ti7^ti8^ti9^ti10^ti11) << initialBlock) |  ( inWords[gid]));
               	                 counter++;
                                 for (ulong ti12=ti11<<2;ti12<word_size;ti12=ti12*2)
                                 {
               	                   outWords[(((gid*secondJump)+(counter+firstJump)))] =  (((ti1^ti2^ti3^ti4^ti5^ti6^ti7^ti8^ti9^ti10^ti11^ti12) << initialBlock) |  ( inWords[gid]));
               	                   counter++;
                                 }//i12
                               }//i11
                             }//i10
