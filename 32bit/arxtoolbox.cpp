...
//  LSARXCL
//
//  Created by Daniel Bodden on 15/03/15.
...
void::arxtoolbox_lib::Arxtoolbox::runCipher()
{
	...
	cl_ulong elementsLengthOut =(1596*1597)+1; //(+1 zero rights)
	cl_ulong elementsLengthIn = 1596;
	...
	cl_ulong word_size = 0xffff; 	        //Inner loop - pre-generated for the 28 bits
	//cl_ulong outerWordsize = 0xfffff; 		//Outer loop - for the bits after 28+16 ... speck 20 bits
	cl_ulong i0 = 0x1;				//Starting pair
	...
	*/
	...
	numberOfThreads =(1596*1597)+1; //fixed size
	size_t globalWorkSizeCalc[1] = {numberOfThreads};  // number of workgroups 2ˆ20
	size_t localWorkSizeCal[1] = {1};
	// Wait with execution until previous kernel is finished
	errNum = clEnqueueNDRangeKernel(queue,kernelCipher,1, NULL, globalWorkSizeCalc, localWorkSizeCal,1,k_eventsGenPairsKernel, NULL);
...
//=============================================
//CONSTRUCTOR
arxtoolbox_lib::Arxtoolbox::Arxtoolbox() // Give arguments when running arxtoolbox program
{
